...
const University = () => {
    ...
    useEffect(() => {
        const fetchUniversity = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/universities/${universityId}`);
    ...
    const openActionLogDialog = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/logs/${universityId}`);
    ...
    const handleDelete = () => {
        axios.delete(`${process.env.REACT_APP_API_URL}/api/universities/${universityId}`)
            .then(response => {
    ...
    const handleSave = (updatedUniversity) => {
        axios.put(`${process.env.REACT_APP_API_URL}/api/universities/${updatedUniversity.id_University}`, updatedUniversity)
            .then(response => {
                setUniversity(response.data);
                closeEditDialog();
            })
